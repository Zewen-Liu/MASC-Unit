...
3. model_chapter3.py: An older version of 'model.py'. It is only need when visualising the example models in the 'models/' folder for  solving the issues of renamed functions.
